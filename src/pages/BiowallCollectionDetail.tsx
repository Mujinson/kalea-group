...
const BiowallCollectionDetail = () => {
  ...
  return (
    <div className="bg-background">
      ...
      <section className="relative z-[2] bg-background pb-20 md:pb-28 px-4 md:px-8 lg:px-12">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {[
            { title: "Spessori", items: collection.spessori },
            { title: "Finiture", items: collection.finiture },
