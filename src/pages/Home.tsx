...
const Home = () => {
  ...
  return (
    <div>
      ...
      {/* Perché MgO */}
      <section className="section-spacing section-overlap bg-background w-full" style={{ zIndex: 2 }}>
      ...
      {/* Applicazioni */}
      <section className="section-spacing section-overlap bg-card w-full" style={{ zIndex: 3 }}>
        <div className="container-custom">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* Sostenibilità */}
      <section className="section-spacing section-overlap bg-background w-full" style={{ zIndex: 4 }}>
        <div className="container-custom">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* CTA Finale */}
      <section className="section-spacing section-overlap bg-primary text-primary-foreground w-full" style={{ zIndex: 5 }}>
