...
const Home = () => {
  ...
  return (
    <div className="relative bg-background">
      ...
      {/* Applicazioni */}
      <section className="relative min-h-screen bg-card">
        <div className="h-full flex flex-col px-6 md:px-12 lg:px-20 py-16 md:py-20">
          {/* Header */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 lg:gap-6 max-w-6xl mx-auto w-full">
            {applications.map((app, index) => (
              <motion.div
                ...
                className="relative rounded-2xl overflow-hidden group aspect-[3/4] md:aspect-[4/5]"
              >
                <img
                  src={app.bg}
                  alt=""
      ...
      <section className="relative min-h-screen bg-background">
        <div className="h-full flex flex-col px-6 md:px-12 lg:px-20 py-16 md:py-20">
          ...
          {/* Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10 max-w-7xl mx-auto w-full">
            {sustainability.map((item, index) => (
              <Link key={item.title} to={item.link} className="block">
                <motion.div
                  ...
                  className="relative rounded-3xl overflow-hidden group aspect-[3/4]"
                >
                  <img
                    src={item.bg}
                    alt=""
      ...
      <section className="relative min-h-[80vh]">
        ...
        <div className="relative z-10 min-h-[80vh] flex items-center justify-center py-20">
          <div className="container-custom text-center">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
