  ...
  const advantages = [
    {
      ...
      description: "Resistente a pioggia e umidità per soffitti esterni esposti.",
    },
    {
      icon: Sun,
      title: "Stabilità UV",
      description: "Colori che non sbiadiscono nel tempo grazie alla protezione UV.",
    },
    {
      icon: Shield,
      title: "Resistenza meccanica",
      description: "Struttura robusta che resiste a vento e sollecitazioni.",
    },
    {
      icon: Palette,
      title: "Estetica raffinata",
      description: "Finiture eleganti per valorizzare portici e verande.",
    },
    {
      icon: AudioWaveform,
      title: "Comfort acustico",
      description: "Proprietà fonoassorbenti per ambienti più silenziosi.",
    },
    {
      icon: CheckCircle,
      title: "Installazione professionale",
      description: "Sistema di montaggio studiato per una posa precisa e veloce.",
    },
  ];

  const applications = [
    "Soffitti per portici",
    "Controsoffitti verande",
    "Pergole e gazebo",
    "Terrazze coperte",
    "Dehors e plateatici",
    "Aree lounge esterne",
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-end pb-24 md:pb-32">
          ...
          >
            <div className="max-w-4xl mx-auto">
              ...
              >
                KALEACEILING<sup className="text-2xl md:text-3xl">®</sup>
              </motion.h1>
              ...
              >
                Rivestimenti per soffitti esterni
              </motion.p>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-foreground mb-4">
              Perché scegliere KALEACEILING
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              La soluzione premium per rivestimenti di soffitti esterni.
            </p>
          </motion.div>
      ...
      <section className="relative z-[3] bg-background py-20 md:py-32">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              La finitura perfetta per ogni copertura esterna.
            </p>
          </motion.div>
