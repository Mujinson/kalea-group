...
import { Layers, Shield, Zap, Settings, Ruler, CheckCircle, Clock, ChevronDown } from "lucide-react";
...
const Kaleabase = () => {
  ...
  const advantages = [
    {
      icon: Layers,
      title: "Versatilità applicativa",
      description: "Sistema modulare adattabile a diverse tipologie di pavimenti e ambienti indoor.",
    },
    {
      icon: Shield,
      title: "Stabilità strutturale",
      description: "Base solida e resistente per una posa perfetta e duratura nel tempo.",
    },
    {
      icon: Zap,
      title: "Installazione rapida",
      description: "Sistema di posa veloce che riduce i tempi di cantiere.",
    },
    {
      icon: Settings,
      title: "Regolazione precisa",
      description: "Permette compensazioni di livello per superfici non perfettamente piane.",
    },
    {
      icon: Ruler,
      title: "Compatibilità universale",
      description: "Progettato per funzionare con tutti i prodotti della linea Kalēa indoor.",
    },
    {
      icon: CheckCircle,
      title: "Qualità certificata",
      description: "Materiali testati e certificati per garantire massime prestazioni.",
    },
  ];
  ...
  return (
    <div className="relative bg-background">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-end pb-24 md:pb-32">
          ...
          >
            <div className="max-w-4xl mx-auto">
              ...
              >
                KALEABASE<sup className="text-2xl md:text-3xl">®</sup>
              </motion.h1>
              ...
              >
                Sistema di posa e supporto per pavimenti indoor
              </motion.p>
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-bold text-foreground mb-4">
              Perché scegliere KALEABASE
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Il sistema di supporto professionale per pavimentazioni indoor di alta qualità.
            </p>
          </motion.div>
      ...
      {/* Technical Section */}
      <section className="relative z-[2] bg-foreground/5 py-20 md:py-32">
        <div className="container-custom">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <ul className="space-y-4 text-background/85">
              <li className="flex items-start gap-3">
                ...
                <span>Materiale: Composito ad alta densità</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-background/60 mt-2 flex-shrink-0" />
                <span>Capacità di carico: fino a 500 kg/m²</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-background/60 mt-2 flex-shrink-0" />
                <span>Regolazione altezza: 0-50 mm</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-background/60 mt-2 flex-shrink-0" />
                <span>Compatibile con riscaldamento a pavimento</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-background/60 mt-2 flex-shrink-0" />
                <span>Sistema di aggancio brevettato</span>
              </li>
            </ul>
          </motion.div>
        </div>
      ...
      <section className="relative z-[3] bg-background py-20 md:py-32">
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Ideale per molteplici contesti architettonici e funzionali.
            </p>
          </motion.div>
        ...
        <div className="container-custom text-center relative z-10">
          ...
          >
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-white/90">
              KALEABASE sarà presto disponibile. Contattaci per maggiori informazioni e per essere tra i primi a scoprire questo innovativo sistema di posa.
            </p>
