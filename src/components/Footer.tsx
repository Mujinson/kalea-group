...
const Footer = () => {
  ...
  const PinterestIcon = ({ size = 24, className = "", strokeWidth = 1.5 }: { size?: number; className?: string; strokeWidth?: number }) => (
    ...
    >
      ...
      <path d="M9.5 13.5c0 0-1 4-1.5 6M12 7c-3 0-5 2-5 5c0 1.5 0.8 2.5 1.5 2.5c0.5 0 1-0.5 0.8-1.5c-0.2-0.8-0.5-1.5-0.5-2.5c0-2 1.5-3.5 3.5-3.5c1.8 0 3 1 3 2.8c0 2-1 4-2.3 4c-0.8 0-1.3-0.7-1.1-1.5c0.2-1 0.7-2 0.7-2.7c0-0.6-0.3-1.1-1-1.1c-0.8 0-1.5 0.8-1.5 2c0 0.7 0.2 1.2 0.2 1.2" />
    </svg>
  );
