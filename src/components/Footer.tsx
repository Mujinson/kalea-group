...
const Footer = () => {
  ...
  const PinterestIcon = ({ size = 24, className = "", strokeWidth = 1.5 }: { size?: number; className?: string; strokeWidth?: number }) => (
    ...
    >
      ...
      <path d="M8 20c.5-2 1.5-5 1.5-5s1 2 3.5 2c3 0 5-2.7 5-6.3 0-3.3-2.7-5.7-6-5.7-4.5 0-7 3.2-7 6.5 0 1.8 1 4 2.5 4.7.2.1.4 0 .4-.2l.3-1.2c0-.2 0-.3-.1-.5-.5-.6-.9-1.7-.9-2.7 0-2.6 2-5.1 5.4-5.1 2.9 0 5.1 2 5.1 4.7 0 3.1-1.6 5.2-3.7 5.2-1.2 0-2.1-1-1.8-2.2.4-1.4 1.1-2.9 1.1-3.9 0-.9-.5-1.6-1.5-1.6-1.2 0-2.1 1.2-2.1 2.8 0 1 .3 1.7.3 1.7z" />
    </svg>
  );
