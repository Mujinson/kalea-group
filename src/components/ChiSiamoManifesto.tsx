...
const lines: Record<string, ReactNode[]> = {
  it: [
    ...
    <>Pavimenti indoor e outdoor in polvere di pietra. Ceramiche. Parquet. WPC.</>,
  ...
  en: [
    ...
    <>Indoor & outdoor stone powder floors. Ceramics. Parquet. WPC.</>,
  ...
  de: [
    ...
    <>Innen- und Außenböden aus Steinpulver. Keramik. Parkett. WPC.</>,
  ...
  fr: [
    ...
    <>Sols intérieurs et extérieurs en poudre de pierre. Céramiques. Parquet. WPC.</>,
