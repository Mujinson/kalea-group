  ...
  it: {
    ...
    partner: {
      hero: {
        ...
        subtitle: "Unisciti al network selezionato di rivenditori, showroom, architetti e imprese che offrono il pavimento MgO più avanzato d'Italia.",
      ...
      why: {
        ...
        tech: {
          ...
          description: "Pavimento in MgO con sistema KalēaLock®, superiore a SPC e laminati.",
        },
        margins: {
          title: "Margini più alti",
          description: "Condizioni riservate con prezzi dedicati ai partner.",
        },
        supply: {
        ...
        marketing: {
          ...
          description: "Brochure, render, campionari e materiale personalizzabile.",
        },
      },
      ideal: {
        title: "Chi è il nostro Partner ideale?",
        description: "Accettiamo collaborazioni solo con professionisti del settore che possono rappresentare il brand Kalēa con qualità e serietà.",
        reseller: "Rivenditori di pavimenti",
        showroom: "Showroom di interni",
        architect: "Architetti e studi di progettazione",
        contractor: "Imprese di ristrutturazione",
        installer: "Posatori professionisti",
      },
      benefits: {
        title: "Cosa offriamo ai Partner Kalēa",
        pricing: "Listini riservati",
        marketing: "Materiale marketing premium",
        training: "Formazione tecnica sul prodotto",
        sales: "Supporto alla vendita",
        samples: "Campionari professionali",
        support: "Assistenza commerciale dedicata",
        priority: "Accesso prioritario a nuove collezioni",
      },
      process: {
        title: "Come funziona la partnership Kalēa",
        step1: "Compila il modulo",
        step2: "Valutazione del tuo profilo (24/48h)",
        step3: "Call conoscitiva + invio listino riservato",
        step4: "Attivazione ufficiale come Partner",
      },
      form: {
        ...
        message: "Messaggio",
        messagePlaceholder: "Raccontaci del tuo business...",
      ...
      testimonials: {
        ...
        quote1: "Kalēa ci ha permesso di differenziarci dalla concorrenza con un prodotto unico e di alta qualità.",
        role2: "Architetto – Roma",
        quote2: "Il supporto tecnico e commerciale è eccezionale. Un partner affidabile per i miei progetti.",
        role3: "Rivenditore – Firenze",
        quote3: "I margini sono ottimi e i clienti apprezzano la qualità superiore del prodotto.",
      },
      applications: {
        residential: "Residenziale moderno",
        commercial: "Spazi commerciali ad alto traffico",
        hospitality: "Hotel & hospitality",
        wet: "Bagni, cucine e ambienti umidi",
      },
      cta: {
  ...
  en: {
    ...
    partner: {
      hero: {
        ...
        subtitle: "Join the select network of retailers, showrooms, architects and companies offering the most advanced MgO flooring in Italy.",
        cta: "Apply to Become a Partner",
      },
      why: {
        title: "Why Partner with Kalēa?",
        tech: {
          title: "Exclusive Technology",
          description: "MgO flooring with KalēaLock® system, superior to SPC and laminates.",
        },
        margins: {
          title: "Higher Margins",
          description: "Reserved conditions with dedicated partner pricing.",
        },
        supply: {
        ...
        marketing: {
          ...
          description: "Brochures, renders, samples and customizable materials.",
        },
      },
      ideal: {
        title: "Who is Our Ideal Partner?",
        description: "We only accept collaborations with industry professionals who can represent the Kalēa brand with quality and professionalism.",
        reseller: "Flooring Retailers",
        showroom: "Interior Showrooms",
        architect: "Architects and Design Studios",
        contractor: "Renovation Companies",
        installer: "Professional Installers",
      },
      benefits: {
        title: "What We Offer Kalēa Partners",
        pricing: "Reserved Price Lists",
        marketing: "Premium Marketing Materials",
        training: "Technical Product Training",
        sales: "Sales Support",
        samples: "Professional Samples",
        support: "Dedicated Commercial Assistance",
        priority: "Priority Access to New Collections",
      },
      process: {
        title: "How the Kalēa Partnership Works",
        step1: "Fill Out the Form",
        step2: "Profile Evaluation (24/48h)",
        step3: "Discovery Call + Reserved Price List",
        step4: "Official Partner Activation",
      },
      form: {
      ...
      testimonials: {
        ...
        quote1: "Kalēa has allowed us to differentiate ourselves from the competition with a unique, high-quality product.",
        role2: "Architect – Rome",
        quote2: "The technical and commercial support is exceptional. A reliable partner for my projects.",
        role3: "Retailer – Florence",
        quote3: "The margins are excellent and customers appreciate the superior quality of the product.",
      },
      applications: {
        residential: "Modern Residential",
        commercial: "High-traffic Commercial Spaces",
        hospitality: "Hotels & Hospitality",
        wet: "Bathrooms, Kitchens and Humid Environments",
      },
      cta: {
        title: "Bring Kalēa to Your Showroom",
        description: "Access the benefits reserved for official partners.",
  ...
  de: {
    ...
    partner: {
      hero: {
        ...
        subtitle: "Treten Sie dem ausgewählten Netzwerk von Händlern, Showrooms, Architekten und Unternehmen bei, die den fortschrittlichsten MgO-Boden Italiens anbieten.",
      ...
      why: {
        ...
        tech: {
          ...
          description: "MgO-Boden mit KalēaLock®-System, überlegen gegenüber SPC und Laminaten.",
        },
        margins: {
          title: "Höhere Margen",
          description: "Reservierte Konditionen mit speziellen Partnerpreisen.",
        },
        supply: {
        ...
        marketing: {
          ...
          description: "Broschüren, Renderings, Muster und anpassbare Materialien.",
        },
      },
      ideal: {
        title: "Wer ist unser idealer Partner?",
        description: "Wir akzeptieren nur Kooperationen mit Branchenprofis, die die Marke Kalēa mit Qualität und Seriosität vertreten können.",
        reseller: "Bodenhändler",
        showroom: "Innenausstattungs-Showrooms",
        architect: "Architekten und Designstudios",
        contractor: "Renovierungsunternehmen",
        installer: "Professionelle Verleger",
      },
      benefits: {
        title: "Was wir Kalēa-Partnern bieten",
        pricing: "Reservierte Preislisten",
        marketing: "Premium-Marketing-Materialien",
        training: "Technische Produktschulung",
        sales: "Verkaufsunterstützung",
        samples: "Professionelle Muster",
        support: "Dedizierte Handelsbetreuung",
        priority: "Prioritärer Zugang zu neuen Kollektionen",
      },
      process: {
        title: "Wie die Kalēa-Partnerschaft funktioniert",
        step1: "Formular ausfüllen",
        step2: "Profilbewertung (24/48h)",
        step3: "Kennenlerngespräch + reservierte Preisliste",
        step4: "Offizielle Partner-Aktivierung",
      },
      form: {
        ...
        message: "Nachricht",
        messagePlaceholder: "Erzählen Sie uns von Ihrem Geschäft...",
      ...
      testimonials: {
        ...
        quote1: "Kalēa hat uns ermöglicht, uns mit einem einzigartigen, hochwertigen Produkt von der Konkurrenz abzuheben.",
        role2: "Architekt – Rom",
        quote2: "Der technische und kommerzielle Support ist außergewöhnlich. Ein zuverlässiger Partner für meine Projekte.",
        role3: "Händler – Florenz",
        quote3: "Die Margen sind ausgezeichnet und die Kunden schätzen die überlegene Qualität des Produkts.",
      },
      applications: {
        residential: "Moderner Wohnbereich",
        commercial: "Gewerbeflächen mit hohem Verkehr",
        hospitality: "Hotels & Gastgewerbe",
        wet: "Bäder, Küchen und feuchte Räume",
      },
      cta: {
  ...
  fr: {
    ...
    partner: {
      hero: {
        ...
        subtitle: "Rejoignez le réseau sélect de revendeurs, showrooms, architectes et entreprises proposant le sol MgO le plus avancé d'Italie.",
      ...
      why: {
        ...
        tech: {
          ...
          description: "Sol MgO avec système KalēaLock®, supérieur aux SPC et stratifiés.",
        },
        margins: {
          title: "Marges plus élevées",
          description: "Conditions réservées avec des prix dédiés aux partenaires.",
        },
        supply: {
        ...
        marketing: {
          ...
          description: "Brochures, rendus, échantillons et matériel personnalisable.",
        },
      },
      ideal: {
        title: "Qui est notre Partenaire idéal ?",
        description: "Nous n'acceptons que les collaborations avec des professionnels du secteur capables de représenter la marque Kalēa avec qualité et sérieux.",
        reseller: "Revendeurs de sols",
        showroom: "Showrooms d'intérieur",
        architect: "Architectes et bureaux d'études",
        contractor: "Entreprises de rénovation",
        installer: "Poseurs professionnels",
      },
      benefits: {
        title: "Ce que nous offrons aux Partenaires Kalēa",
        pricing: "Tarifs réservés",
        marketing: "Matériel marketing premium",
        training: "Formation technique produit",
        sales: "Support à la vente",
        samples: "Échantillonnage professionnel",
        support: "Assistance commerciale dédiée",
        priority: "Accès prioritaire aux nouvelles collections",
      },
      process: {
        title: "Comment fonctionne le partenariat Kalēa",
        step1: "Remplissez le formulaire",
        step2: "Évaluation de votre profil (24/48h)",
        step3: "Appel découverte + envoi tarif réservé",
        step4: "Activation officielle en tant que Partenaire",
      },
      form: {
        ...
        category: {
          ...
          contractor: "Entreprise du bâtiment",
          installer: "Poseur",
        },
      ...
      testimonials: {
        ...
        role1: "Showroom – Milan",
        quote1: "Kalēa nous a permis de nous différencier de la concurrence avec un produit unique et de haute qualité.",
        role2: "Architecte – Rome",
        quote2: "Le support technique et commercial est exceptionnel. Un partenaire fiable pour mes projets.",
        role3: "Revendeur – Florence",
        quote3: "Les marges sont excellentes et les clients apprécient la qualité supérieure du produit.",
      },
      applications: {
        residential: "Résidentiel moderne",
        commercial: "Espaces commerciaux à fort trafic",
        hospitality: "Hôtels & hôtellerie",
        wet: "Salles de bains, cuisines et environnements humides",
      },
      cta: {
